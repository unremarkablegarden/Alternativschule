<template lang="pug">
  #subjectadd
    ...
    el-dialog(title='Add user', :visible.sync='dialogVisible', width='800')

      el-form(:model='addUserForm', ref='addUserForm', :rules='rules', label-width='110px', :close-on-click-modal='false', v-loading='loading', status-icon).adduserform
        ...
        el-form-item
          el-button(type='primary', @click="submitForm('addUserForm')", :loading='loading')
            span(v-if='loading') Adding
            span(v-else) Add user
</template>
