<template>
  <div id="app">
    <div id="nav">
      ...
      <router-link to="/areamap">Area Map | </router-link> 
      <router-link to="/areamap/subjects">Subject Map | </router-link>
      <router-link to="/areamap/subjects/single">Subject Single</router-link>
    </div>
    <router-view id="view"/>
  </div>
</template>
